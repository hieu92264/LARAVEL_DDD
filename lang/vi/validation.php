...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ sau chứa thông báo lỗi mặc định được validator sử
    | dụng. Một số rule có nhiều phiên bản, ví dụ các rule về kích thước.
    | Bạn có thể chỉnh sửa từng thông báo cho phù hợp với ứng dụng.
    |
    */
    ...
    'missing' => 'Trường :attribute phải không được gửi lên.',
    'missing_if' => 'Trường :attribute phải không được gửi lên khi :other là :value.',
    'missing_unless' => 'Trường :attribute phải không được gửi lên trừ khi :other là :value.',
    'missing_with' => 'Trường :attribute phải không được gửi lên khi :values có mặt.',
    'missing_with_all' => 'Trường :attribute phải không được gửi lên khi :values có mặt.',
    ...
    |--------------------------------------------------------------------------
    |
    | Tại đây bạn có thể chỉ định thông báo validation tùy chỉnh cho từng
    | attribute bằng quy ước "attribute.rule". Điều này giúp khai báo nhanh
    | một dòng ngôn ngữ cụ thể cho một rule của attribute.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ sau được dùng để thay placeholder attribute bằng
    | tên dễ đọc hơn, ví dụ "Địa chỉ email" thay vì "email". Điều này giúp
    | thông báo rõ ràng và tự nhiên hơn.
    |
    */
